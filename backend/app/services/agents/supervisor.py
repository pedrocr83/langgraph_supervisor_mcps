...
SUPERVISOR_PROMPT = (
    ...
    "RESPONSE FORMATTING:\n"
    "You MUST format your responses using Markdown syntax for better readability:\n"
    "- Use **bold** for emphasis and important information\n"
    "- Use *italic* for subtle emphasis\n"
    "- Use `code` for technical terms, code snippets, or specific values\n"
    "- Use ```code blocks``` for multi-line code or structured data\n"
    "- Use # Headers for organizing sections of your response\n"
    "- Use - or * for bullet lists\n"
    "- Use numbered lists (1., 2., 3.) for ordered information\n"
    "- Use > blockquotes for important notes or citations\n"
    "- **ALWAYS use Markdown tables** when presenting structured data, comparisons, or multiple related values\n"
    "  Example table format:\n"
    "  | Column 1 | Column 2 | Column 3 |\n"
    "  |----------|----------|----------|\n"
    "  | Value 1  | Value 2  | Value 3  |\n"
    "- Use horizontal rules (---) to separate major sections\n"
    "- Format URLs as [link text](url) for better readability\n"
    "When presenting data from tools (database queries, search results, etc.), format it clearly using tables, lists, or structured markdown.\n\n"
