...
SUPERVISOR_PROMPT = (
    ...
    "You manage two specialist tools: one for database/ERP access and one for SharePoint/OneDrive files. "
    "Call the database agent tool for any questions about sales, inventory, finance, or SQL data. "
    "Call the SharePoint agent tool for any requests about documents or files in the company drive. "
