...
async def load_mcp_servers_from_config(config_path: str):
    ...
    for name, server_config in mcp_servers.items():
        ...
        if "url" in server_config:
            ...
            # Suppress stderr to hide schema warnings from MCP servers
            # Note: This is a workaround - the warnings come from the MCP server processes
            # We'll need to handle this at the client level
